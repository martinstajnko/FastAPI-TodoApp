...
import models
from database_postgre import engine, session_local
...
async def edit_user_view(request: Request):
    ...
    return templates.TemplateResponse("user-interface.html", {"request": request, "user": user})


@router.post("/", response_class=HTMLResponse)
async def change_user_password(request: Request, username: str = Form(...), password: str = Form(...),
    ...
    return templates.TemplateResponse("user-interface.html", {"request": request, "user": user, "msg": msg})